...
function FaqRow({ item, isOpen, onToggle }) {
  return (
    <div className={`w-full rounded-[12px] px-[20px] py-[16px] shadow-[0px_1px_4px_0px_rgba(51,51,51,0.15)] transition-colors duration-300 ${isOpen ? "bg-white" : "bg-white/40 hover:bg-white/70"}`}>
...
function FaqCategoryBlock({ categoryIndex }) {
  ...
  const [openIndices, setOpenIndices] = useState(() => new Set([defaultOpenIndex]));
