...
import { TrustedMapSection } from "./sections/TrustedMap";
...
export default function TrustedPage() {
  return (
    ...
    <div className="bg-[#f3edff] content-stretch flex flex-col items-start relative size-full pt-[190px] md:pt-[80px]" data-name="Trusted page">
      <TrustedMapSection />
      <FooterLegalBarLeft />
      <FooterLegalBarRight />
      <DarkFooterSection />
