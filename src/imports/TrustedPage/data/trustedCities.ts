...
export type TrustedOrg = { name: string; logo: string };
export type TrustedCity = { id: string; label: string; cx: number; cy: number; orgs: TrustedOrg[] };

// cx/cy are coordinates on the poland-map.svg viewBox (0 0 646.47 555.32).
export const TRUSTED_CITIES: TrustedCity[] = [
  {
    id: "warszawa",
    label: "Warszawa",
    cx: 412.82,
