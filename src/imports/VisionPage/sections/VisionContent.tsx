...
function VisionStatementRow() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-[24px] md:gap-[48px] w-full">
      <div className="flex flex-1 items-center justify-center p-[12px] md:p-[24px]">
      ...
      <div className="flex flex-1 items-center justify-center p-[12px] md:p-[24px] min-w-0">
        <img alt="" className="w-full max-w-[400px] md:max-w-none" src={imgWizja1} />
      </div>
    </div>
  );
}
...
function VisionCopyRow() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-[24px] md:gap-[48px] w-full">
      <div className="flex flex-1 items-center justify-center p-[12px] md:p-[24px] min-w-0">
        <img alt="" className="w-full max-w-[400px] md:max-w-none" src={imgWizja2} />
      </div>
      <div className="flex flex-1 flex-col items-center justify-center p-[12px] md:p-[24px]">
