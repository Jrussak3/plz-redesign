...
function TestimonialCard({ testimonial, isActive, isPeek, width, instant, onClick }) {
  return (
    <div
      onClick={onClick}
        ...
        <div className="content-stretch flex gap-[20px] items-center justify-center relative shrink-0" data-name="div.swiper-pagination">
          {TESTIMONIALS.map((_, i) => (
            <button
              ...
              className="content-stretch cursor-pointer flex flex-col h-[30px] items-center justify-center px-[4px] relative shrink-0 w-[38px] group"
            >
              <div className={`bg-[#6750a4] relative rounded-[15px] shrink-0 transition-all duration-300 group-hover:bg-[#573f8a] ${i === activeIndex ? "size-[30px]" : "size-[20px]"}`} data-name="span.swiper-pagination-bullet">
