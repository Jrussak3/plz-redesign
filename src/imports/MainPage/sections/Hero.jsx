...
import { PillButtonFill, PillButtonShadow } from "./shared";
// Placeholder — swap these two for the dedicated mobile/desktop hero illustrations.
import imgHeroIllustrationMobile from "../../../Assets/4df8dc349d361968c54c12503812e18c684899e0.png";
import imgHeroIllustrationDesktop from "../../../Assets/4df8dc349d361968c54c12503812e18c684899e0.png";
...
function HeroButton({ label, href, backgroundClassName, textClassName }) {
  const Tag = href ? "a" : "div";
  return (
    <Tag
      {...(href ? { href } : {})}
      className="content-stretch flex items-center justify-center px-[32px] py-[20px] relative rounded-[16px] shrink-0 w-full sm:w-auto transition-opacity hover:opacity-90"
    >
      <PillButtonFill backgroundClassName={backgroundClassName} />
