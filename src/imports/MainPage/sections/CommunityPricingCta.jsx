...
import { GRADIENT_LILAC, PillButtonFill, PillButtonShadow } from "./shared";
...
function CommunityPricingCopy() {
  return (
    <div className="content-stretch flex flex-1 md:flex-[4_0_0] lg:flex-[1_0_0] flex-col gap-[24px] md:gap-[40px] items-start justify-center min-w-px relative w-full md:w-auto" data-name="Text">
      ...
      <Link
        to="/cennik"
        className="content-stretch flex items-center justify-center px-[32px] py-[20px] relative rounded-[16px] shrink-0 group"
        data-name="Button"
      >
        <PillButtonFill backgroundClassName="bg-white transition-colors group-hover:bg-[#f3edff]" />
...
function CommunityPricingCard() {
  return (
    <div
      className={`content-stretch flex flex-col md:flex-row gap-[24px] md:gap-[120px] items-start md:items-end justify-center overflow-clip px-[24px] md:px-[80px] py-[40px] md:py-[120px] relative rounded-[24px] shrink-0 w-full md:max-w-[1550px] ${GRADIENT_LILAC}`}
      data-name="Wrapper"
    >
